...
La introducción debe indicar cuál es el problema o tema abordado en el documento, su importancia, los antecedentes y el objetivo principal del estudio o propuesta. Adicionalmente, debe indicar el contenido del documento.
...
```{r my_hist, echo=FALSE, fig.cap="Histograma de valores simulados de una N(0, 1)", fig.width=5, fig.height=3}
hist(rnorm(100), main='No colocar el título aquí, colocarlo abajo',
     col='deepskyblue3', las=1)
```

Otra forma de incluir figuras es importándolas. A continuación un ejemplo.

```{r inst2, echo=F, fig.cap='Diagrama de dispersión hecho manualmente.', out.width = '50%', fig.align='center'}
